...
public class FakeApiService implements ApiService {
    ...
    public void generateRandomUser() {
        // TODO_ok: A modifier
        //User randomElement = FAKE_USERS_RANDOM.get(new Random().nextInt(FAKE_USERS_RANDOM.size()));
        //users.add(randomElement);
        users.add(User.random()); // en recherchant FAKE_USERS_RANDOM dans le code, j'ai trouvé la même fonction déjà faite dans la class User.
    }
